...
log_file_name = f"lasso_training_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
logging.info("Lasso training script started")
...
# MODEL NAME
MODEL_NAME = "lasso_rmse.pkl"
MODEL_FOLDER = "lasso_rmse"
...
if __name__ == "__main__":
    ...
    try:
        ...
        final_model = Pipeline(
            [
                ("scaler", StandardScaler()),
                ("regressor", Lasso(**best_params, max_iter=10000)),
            ]
        )
