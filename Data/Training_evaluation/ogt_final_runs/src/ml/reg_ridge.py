...
log_file_name = f"ridge_training_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
logging.info("Ridge training script started")
...
# MODEL NAME
MODEL_NAME = "ridge_rmse.pkl"
MODEL_FOLDER = "ridge_rmse"
...
if __name__ == "__main__":
    ...
    try:
        ...
        final_model = Pipeline(
            [
                ("scaler", StandardScaler()),
                ("regressor", Ridge(**best_params, random_state = RANDOM_STATE)),
            ]
        )
