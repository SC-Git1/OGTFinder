"""
Script to retrain Sauer and Wang's model. The code was modified from: https://github.com/DavidBSauer/OGT_prediction/
"""
...
import OGT_prediction.regression.genome_to_species as feature_average
import OGT_prediction.regression.feature_regression as feature_regression
import OGT_prediction.regression.multi_lin_regression as multi_lin_regression
import random
import OGT_prediction.regression.feature_assignment_venn as venn
import csv
import OGT_prediction.regression.histogram_calc as histogram
import OGT_prediction.regression.cross_corr as cross_corr
...
# 1. species_OGT_file
# 2. train_test_file
# 3. species_taxon_file
# 4. file with: genome_features tRNA_features rRNA_features ORF_features Protein_features

#whole pipeline
species_OGT_file = argv[1]
logger.info('Species-OGT file: '+species_OGT_file)
train_test_species_file = argv[2] 
...
for clade in ['all_species']:
	...
	#del rvalues['genomic Total Size'] -> sowieso ok?
