"""
C11: TabR - Retrieval-Augmented Tabular Regression

Architecture: MLP encoder with self-attention as proxy for retrieval.

Key ideas:
- Learn feature representation
- Attention-based retrieval mechanism
- Combines memorization with generalization

Features:
- Optuna hyperparameter tuning
- Self-attention based retrieval approximation

Paper: "TabR: Tabular Deep Learning Meets Nearest Neighbors"

Designed for: ~8k samples, ~1000 features, regression task

Usage:
    python reg_tabr.py <train_data_path> <test_data_path>
"""
...
def build_tabr(
    ...
    Uses self-attention as proxy for retrieval during training.

    Args:
        input_shape: Number of input features
        hidden_units: Hidden layer sizes for encoder
    ...
    # Self-attention (as proxy for retrieval)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train TabR with Optuna hyperparameter optimization'
    )
